...
function Bg_mra() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:4000/save/view-hotel/${itemId}`)
            .then((res) => {
                ...
                <div className='row'>
                    ...
                    <div className='' id='bg-mra-div2'>
                        <p>Indian ,Asian ,VegetarianFriendly
                            <br />  |<i class="bi bi-geo-alt-fill"></i> {item.place} {item.district}|
                ...
                <div className='row' id='bg-mra-img-div'>
                    <div className='col-lg-12 '>
                        <div className="container text-center">
                            <div className="row">
                                <div className="col"><img className='img-fluid' alt="..." src='/mra7.jpg' /><img src='/mra6.jpg' /></div>
                                <div className="col"><img className='img-fluid' alt="..." src='/mra6.jpg' /><img src='/mra9.jpg' /></div>
                                <div className="col"><img className='img-fluid' alt="..." src='/mra8.jpg' /><img src='/mra7.jpg' /></div>
